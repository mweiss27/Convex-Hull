...
import com.weiss.algorithms.convexhull.swing.FlowPanel;
import com.weiss.algorithms.convexhull.swing.VerticalFlowPanel;
import com.weiss.algorithms.convexhull.util.AlgorithmsConfig;
	...
	public PointMapUI(final Dimension size) {
		...
		this.pointView = new JPanel() {
			...
			protected void paintComponent(Graphics g1) {
				...
				if (PointMapUI.this.allPoints != null) {
					PointMapUI.this.drawPointMap(PointMapUI.this.allPoints, g);
				}

				if (PointMapUI.this.solution != null) {
					PointMapUI.this.drawSolution(PointMapUI.this.solution, g);
				}
		...
		this.generateNewPoints.getActionMap().put("new", new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				PointMapUI.this.generateNewPoints.doClick();
			}
		});
		...
		this.generateSolution.getActionMap().put("solve", new AbstractAction() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				PointMapUI.this.generateSolution.doClick();
			}
		});
