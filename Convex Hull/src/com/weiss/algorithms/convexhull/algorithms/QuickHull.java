...
import com.weiss.algorithms.convexhull.util.Log;
import com.weiss.algorithms.convexhull.util.Point;
import com.weiss.algorithms.convexhull.util.Time;
...
public class QuickHull extends CHAlgorithm {
	...
	private void quickhull(final Point[] endPoints, final List<Point> hullPoints, final List<Point> includedPoints) {
		...
		this.quickhull(newEndPoints, hullPoints, newIncludedPoints);
